...
DATABASE_RELATIVE_PATH='database/database.sqlite'
DATABASE_PATH=f'sqlite:///{DATABASE_RELATIVE_PATH}'
SQLALCHEMY_TRACK_MODIFICATIONS=False #Tell SQLAlchemy that we don't want to know when things are committed
